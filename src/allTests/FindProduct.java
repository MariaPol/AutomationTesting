...
public class FindProduct {
	...
	public void goToProductPage() {
		...
		String productTitle = Wdriver.driver.findElement(By.cssSelector("#result_4 > div > div > div > div.a-fixed-left-grid-col.a-col-right > div.a-row.a-spacing-small > div:nth-child(1) > a > h2")).getText();
